                                ...
                                @forelse($topics as $i => $topic)
                                    <tr>
                                        ...
                                        @foreach($filepath as $newattach)
                                            ...
                                            @endphp
                                            <a href="{{ asset('storage/' . $newattach["path"]) }}" target="_blank" class="btn btn-sm btn-info mb-1 text-truncate d-inline-block" style="max-width: 140px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">

        ...
        <div class="container-fluid">
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('admin.assignments.store', $course) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            <label for="file">Assignment Files <span class="text-danger">*</span></label>
                            ...
                            <small class="form-text text-muted">You can upload multiple files. Allowed: pdf, doc, docx, ppt, pptx, mp4, avi, mov, wmv, jpg, jpeg, png, gif. Max size: 50MB each.</small>
                        </div>
